...
import com.ptc.windchill.dsg.part.WTPart2PartStructureConnector;
	...
	public static void createLink(String fileName) throws WTException ,FileNotFoundException
	{
		...
		{  
			...
			try {
				...
				/*qs.appendAnd();
				qs.appendWhere(new SearchCondition(WTPart.class, "iterationInfo.latest", wt.query.SearchCondition.IS_TRUE));*/
				qs.appendAnd();
				qs.appendWhere(new SearchCondition(WTPart.class, ViewManageable.VIEW + "." + ObjectReference.KEY, SearchCondition.EQUAL, PersistenceHelper.getObjectIdentifier(view)), new int[]{0});
